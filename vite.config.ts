...
export default defineConfig({
  fmt: {
    ...
    // Both round-trip every weekly run; format-checking them just makes
    // the bot fight oxfmt's whitespace rules without buying anything.
    ignorePatterns: ["data/crawled/**", "src/data/programs.generated.ts"],
  },
  plugins: [react()],
