// fallow-ignore-file duplicate-export -- shadowing the `export * from
// "./_default.mjs"` names below is exactly how a campus module tightens the
// defaults; see the header of _default.mjs.
